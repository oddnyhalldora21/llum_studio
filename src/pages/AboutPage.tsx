function AboutPage() {
    return (
      <div style={{ backgroundColor: '#e8e0d8' }}>
        ...
        {/* Contact section */}
        <section className="px-16 py-16 grid grid-cols-2 gap-16 border-t" style={{ borderColor: '#2c181020' }}>
          <p className="text-sm leading-relaxed" style={{ color: '#2c1810' }}>
          ...
          <ul className="space-y-2">
            {['General Inquiries', 'Sales Inquiries', 'Press Inquiries', 'Telephone', 'Instagram'].map(item => (
              <li key={item}>
                <a href="#" className="text-sm hover:opacity-60 transition-opacity" style={{ color: '#2c1810' }}>{item}</a>
              </li>
            ))}
          </ul>
        </section>
