    ...
    return (
      <div className="max-w-5xl mx-auto px-8 py-16 flex gap-16">
        ...
        <div className="flex-1">
          ...
          <button className="w-full py-4 bg-stone-900 text-white text-sm hover:bg-stone-700 transition-colors">
            Place Order
          </button>
        </div>
        ...
        <div className="w-80 shrink-0">
          ...
          <div className="flex gap-4 mb-6">
            ...
            <div className="flex-1">
              <p className="text-sm text-stone-900">Cosmos Chandelier</p>
              <p className="text-sm text-stone-400">Finish: Brass</p>
            </div>
