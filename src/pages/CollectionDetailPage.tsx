          ...
          {collectionsData.map((collection) => (
            ...
            >
              ...
              <div className="relative w-full overflow-hidden" style={{ height: '100vh' }}>
                ...
                <div className="absolute inset-0 flex items-end px-8 md:px-16 pb-12">
                  <h2 className="font-light tracking-widest" style={{ fontSize: 'clamp(2.5rem, 6vw, 5rem)', color: '#f5f0eb', fontFamily: 'Cormorant Garamond, serif' }}>
                    {collection.name}
                  </h2>
                </div>
              </div>
              ...
              {collection.photos && collection.photos.length > 0 && (
                <>
                  ...
                  <div className="flex flex-col md:flex-row gap-4 px-8 md:px-16 py-8 md:py-12">
                    ...
                    <div className="flex flex-row md:flex-col md:w-80 gap-4">
                      {collection.photos[1] && (
                  ...
                  {collection.photos.length > 3 && (
                    <div className="flex flex-col md:flex-row gap-4 px-8 md:px-16 pb-8 md:pb-12">
              ...
              {/* Fallback alternating layout */}
              {(!collection.photos || collection.photos.length === 0) && collection.sections.map((section, i) => (
                <div key={i} className={`flex flex-col md:flex-row ${i % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                  ...
                  <div className="w-full md:w-1/2 flex items-center px-8 md:px-16 py-8 md:py-16">
